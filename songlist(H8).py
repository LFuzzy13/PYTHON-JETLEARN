...
W=Tk()
W.title("Playlist Creator and saver")
...
fopen=Button(W, text="open previous playlist",command=openfilesource, width=15)
fdelete=Button(W, text="delete song", command=deleteitem, width = 15)
fsave=Button(W,text="save playlist to PC", command=savingfile, width = 15)

fopen.pack(side=LEFT,padx=5,pady=5)
fdelete.pack(side=RIGHT,padx=5,pady=5)
fsave.pack(padx=5,pady=5)

BtnADD = Button (W, text="add song to playlist", command=additem, width = 50)
